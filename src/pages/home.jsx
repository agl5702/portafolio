...
function Home() {
  return (
    ...
    >
      <Box
        p="20px"
        w={{ base: "360px", sm: "390px", md: "450px", lg: "500px" }}
        display="flex"
      ...
      >
        ...
        <Text
          ...
          fontSize={{ base: "35px", sm: "50px", md: "60px", lg: "75px" }}
          fontWeight="bold"
        >
          soy Ángel
        </Text>
        <Text
          fontWeight="bold"
          fontSize={{ base: "16px", sm: "20px", md: "25px", lg: "28px" }}
          color="green.300"
        >
        ...
        <Text
          textAlign="justify"
          color={{ base: "white", sm: "white", md: "white", lg: "white" }}
          fontSize={{ base: "16px", sm: "18px", md: "19px", lg: "20px" }}
        >
          Apasionado por la programación y resolver bugs, mientras tomo una taza
          de café.
        </Text>
        <Button
          as="a"
      ...
      <Box position="relative" m="auto" display="flex" justifyContent="center">
        <Image
          src={img_angel}
          borderRadius="full"
          boxSize={{ base: "150px", sm: "250px", md: "350px", lg: "450px" }}
        />
      </Box>
    </Box>
  );
